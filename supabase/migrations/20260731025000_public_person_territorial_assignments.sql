...
comment on view public.public_person_territorial_assignments is
  'Asignaciones públicas vigentes de personas con contexto territorial eclesial. El país representa el ámbito de servicio, no nacionalidad ni lugar de nacimiento.';
