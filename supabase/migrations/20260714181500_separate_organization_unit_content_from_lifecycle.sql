...
begin
  ...
  -- El guardado ordinario modifica contenido y jerarquía, no ciclo de vida.
  -- Las transiciones de estado y publicación pasan exclusivamente por
  -- public.admin_transition_organization_unit(jsonb).
  v_content_payload := payload - 'status' - 'visibility';
