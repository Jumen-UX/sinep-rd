...
export type StructureNodeDetail = {
  node: {
    ...
    linked_ecclesiastical_entity_id: string | null; linked_organization_unit_id: string | null;
...
export type SaveStructureNodePayload = { id?: string | null; template_id: string; level_id: string; parent_node_id?: string | null; name: string; official_name?: string | null; slug: string; code?: string | null; description?: string | null; linked_ecclesiastical_entity_id?: string | null; linked_organization_unit_id?: string | null; start_date?: string | null; end_date?: string | null; is_current?: boolean; source_name?: string | null; source_url?: string | null; source_checked_at?: string | null; metadata?: Record<string, unknown>; status?: string; visibility?: string }
