...
test('floating tools expose persistent keyboard-operable accessibility and theme preferences', async () => {
  ...
  assert.match(component, /useThemePreference/)
  assert.match(component, /type ThemePreference/)
  assert.match(component, /role="dialog"/)
  assert.match(component, /aria-modal="false"/)
  assert.match(component, /aria-controls=\{panelId\}/)
  assert.match(component, /aria-expanded=\{open\}/)
  assert.match(component, /aria-label="Abrir herramientas de accesibilidad"/)
  assert.match(component, /aria-label="Herramientas de accesibilidad"/)
  assert.match(component, /<h2 id=\{headingId\}>Accesibilidad y apariencia<\/h2>/)
  assert.match(component, /event\.key !== 'Escape'/)
  assert.match(component, /triggerRef\.current\?\.focus\(\)/)
  assert.match(component, /aria-pressed=\{preferences\.textScale === value\}/)
  assert.match(component, /aria-pressed=\{themePreference === value\}/)
  assert.match(component, /\['light', 'Claro'\]/)
  assert.match(component, /\['dark', 'Oscuro'\]/)
  assert.match(component, /\['system', 'Automático'\]/)
  ...
  assert.match(component, /updateThemePreference\('system'\)/)
