...
test('people directory supports searchable pastoral territory filters without duplicating people', async () => {
  ...
  assert.match(styles, /\.people-list-table td::before/)
  assert.match(styles, /content: 'Nombre'/)
  assert.match(styles, /content: 'Condición'/)
  assert.match(styles, /content: 'Servicio pastoral vigente'|content: 'Información publicada'/)
