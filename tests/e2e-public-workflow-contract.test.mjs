...
test('public E2E workflow runs Chromium and Axe without privileged credentials', async () => {
  ...
  assert.match(workflow, /pnpm exec playwright test e2e\/public-accessibility\.spec\.mjs e2e\/visual-evidence\.spec\.mjs --update-snapshots/)
  assert.match(workflow, /e2e\/visual-evidence\.spec\.mjs-snapshots/)
