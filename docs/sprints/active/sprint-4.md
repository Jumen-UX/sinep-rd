...
3. [ ] S4-03 — Aplicar el asistente común a obispos, sacerdotes, diáconos, religiosos y laicos. **En progreso:** componente común creado; asistentes de diácono, sacerdote y obispo migrados y protegidos por pruebas contractuales.
...
Los asistentes de diácono, sacerdote y obispo ya consumen el componente común sin modificar sus contratos de persistencia. Sacerdote conserva la continuidad desde `existing_deacon_person_id`; obispo conserva `selected_clergy_id` y mantiene separados ordenación episcopal, función, estado, dignidades, nombramiento y fuente. Cada integración tiene una prueba contractual específica.

Los siguientes flujos a migrar son vida consagrada y laico. Estos asistentes conservan temporalmente compatibilidad heredada hasta completar S4-03.
