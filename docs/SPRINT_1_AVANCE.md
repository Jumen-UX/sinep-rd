...
- `/admin/eventos`, `/admin/eventos/nuevo`, `/admin/eventos/pendientes` y `/admin/eventos/[eventId]` delegan en `features/events`.
...
2. Extraer las páginas monolíticas restantes por prioridad de riesgo: plan y contrato de eventos, e importaciones.
